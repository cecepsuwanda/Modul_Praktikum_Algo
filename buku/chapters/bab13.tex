...
Unit pertama berisi fungsi-fungsi operasi matematika dasar yang dapat digunakan kembali di berbagai program:
...
Unit kedua berisi operasi matematika yang lebih kompleks seperti pangkat, faktorial, dan akar kuadrat:
